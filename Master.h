...
class Master {
    ...
    PhotoPtr createPhoto(string name);
    VideoPtr createVideo(string name);
    FilmPtr createFilm(string name);
    GroupPtr createGroup(string name);

    void printObject(string name) const;
    void printGroup(string name) const;
